...
// const jsonstring = {"logs":"[{\"action\":\"searchkeywordclient\",\"json\":{\"type\":\"song\",\"keyword\":\"安妮的仙境1\",\"offset\":0}}]","csrf_token":""};
const searchArgs = {
    logs: [{
        action: 'searchkeywordclient',
        json: { type: 'song', keyword: '安妮的仙境', offset: 0 }
    }],
    csrf_token: '',
};

// const str = JSON.stringify(searchArgs);
const str = '{"hlpretag":"<span class=\\"s-fc7\\">","hlposttag":"</span>","s":"asdf","type":"1","offset":"0","total":"true","limit":"30","csrf_token":""}';

const rest = ["010001", "", "0CoJUm6Qyw8W8jud"]

const result = asrsea(str, ...rest);
